...
for entry in all:
    ...
    if genre is None or name is None or artist is None or album is None:
        continue
...
data = cur.fetchall()
table = tabulate(data, headers=("ID","title", "album_id", "genre_id", "len", "rating", "count"), tablefmt="grid")
print(table)
conn.close()
